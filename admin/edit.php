<?php
    ...
    $id = $_GET['id'];
        ...
        if(isset($_POST['submit'])){
            ...
            $update = mysqli_query ($connection,"update flower_data 
                                                      set bouquet_name='$bouquetname', 
...
<body>
    <div class="d-flex" id="overallDasboard">
        ...
        <div class="secondary-bg" id="sidebarDasboard">
            ...
            <div class="list-group list-group-flush mb-3 ">
                ...
                <a href="manage.php" class="list-group-item list-group-item-action bg-transparent active primary-text fw-bold">
        ...
        <div id="mainDasboard">
            <nav class="navbar navbar-expand-lg navbar-light secondary-bg py-4 px-4 border-start">
                ...
                <div class="d-flex align-items-center primary-text">
                    ...
                    <h2 class="fs-4 fw-bold m-0">Correction</h2>
                </div>
                <!------------- left 2item end----------->
                <!------------- right item ----------->
  ...
  <!------------------------------------- Edit details --------------------------------------->
            <div class="container-fluid px-4 form_details details_area">
                <div class="edit-form d-flex justify-content-center align-item-center  my-5">
                <form method="post" enctype="multipart/form-data" class=" p-3 edit-form">

                        <?php

                            $getdatas = mysqli_query($connection, "select * from flower_data where no='$id'");

                            $arr = mysqli_fetch_array($getdatas);

                        ?>

                    <div class="name">
                        <label for="">Bouquet Name</label><br>
                        <input name="bouquet_name" value="<?php echo $arr['bouquet_name'];  ?>" class="text_area" type="text" required>
                    </div>
                    <div class="offer_price">
                        <label for="">Offere Price</label><br>
                        <input name="offer_price" value="<?php echo $arr['offer_price']; ?>" class="text_area" type="text" required>
                    </div>
                    <div class="Price">
                        <label for="">Price</label><br>
                        <input name="price" value="<?php echo $arr['price'];?>" class="text_area" type="text" required>
                    </div>
                    <div class="image">
                        <label for="">Image</label><br>
                        <img class="product_img  mb-3" src="images/<?php echo $arr['image']; ?>"  width="80px" height="80px">
                        <input name="image" value="<?php echo $arr['image']; ?>" class="upload_img form-control" type="file" required>
                    </div>
                    <div class="submit mt-3 d-flex justify-content-end">
                        <input name="submit" class="py-2 px-5 submit_btn text-light " type="submit" value="submit">
                    </div>
                </form>
            </div>
                <!-------------Edit details  end----------->
