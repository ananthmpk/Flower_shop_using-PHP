        ...
        <div id="mainDasboard">
            <nav class="navbar navbar-expand-lg navbar-light secondary-bg py-4 px-4 border-start">
                ...
                <div class="d-flex align-items-center primary-text">
                    ...
                    <h2 class="fs-4 fw-bold m-0">Remove</h2>
                </div>
                <!------------- left 2item end----------->
                <!------------- right item ----------->
                ...
                <table class="table bg-white rounded shadow-sm table-hover my-5">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Delete or Remove</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr['price']; ?></td></td>
                            <td><img class="img-fluid product_img " width="100px" height="100px"
                                    src="images/<?php echo $arr['image'] ?>" alt=""></td>
                            <td><a href="delete.php?id=<?php echo $arr['no'] ?>"><button type="button" class="btn btn-danger px-4 py-1 mt-4">Remove</button></a></td>
