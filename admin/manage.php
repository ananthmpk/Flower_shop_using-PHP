        ...
        <div id="mainDasboard">
            <nav class="navbar navbar-expand-lg navbar-light secondary-bg py-4 px-4 border-start">
                ...
                <div class="d-flex align-items-center primary-text">
                    ...
                    <h2 class="fs-4 fw-bold m-0">Manage</h2>
                </div>
                <!------------- left 2item end----------->
                <!------------- right item ----------->
            ...
            <div class="container-fluid px-4 details_area ">
                <table class="table bg-white rounded shadow-sm table-hover my-5">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr['bouquet_name'];  ?></td>
                            <td><?php echo $arr['offer_price']; ?></td>
                            <td><?php echo $arr['price']; ?></td>
                            <td><img class="img-fluid product_img " width="100px" height="100px"
                                    src="images/<?php echo $arr['image'] ?>" alt="Bouquet Name"></td>
                            <td><a href="edit.php?id=<?php echo $arr['no']; ?>"><button type="button"
                                        class="btn btn-danger px-4 py-1 mt-4">Edit</button></a></td>
                            <td><a href="view.php?id=<?php echo $arr['no']; ?> "><button type="button"
                                        class="btn btn-success px-3 py-1 mt-4">View</button></td></a>
                        </tr>
