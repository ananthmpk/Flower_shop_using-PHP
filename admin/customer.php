    ...
    <div class="d-flex" id="overallDasboard">
        ...
        <div class="secondary-bg" id="sidebarDasboard">
            ...
            <div class="list-group list-group-flush mb-3 ">
                ...
                <a href="customer.php" class="list-group-item list-group-item-action bg-transparent active primary-text fw-bold">
        ...
        <div id="mainDasboard">
            <nav class="navbar navbar-expand-lg navbar-light secondary-bg py-4 px-4 border-start">
                ...
                <div class="d-flex align-items-center primary-text">
                    ...
                    <h2 class="fs-4 fw-bold m-0">Customers</h2>
                </div>
                <!------------- left 2item end----------->
                <!------------- right item ----------->
...
<!------------=-------------- Customer details ------------------------------------------->
            <div class="container-fluid px-4 details_area">
                <table class="table bg-white shadow-sm table-hover my-5">
                    <thead>
                        <tr>
